...
// INSERT POINT: _init
	...
	_start: function (e) {
		...
		//自定义代码段
//		var SW=screen.width;
//		var MarginLeft = parseInt($('#mainPart').css("margin-left").replace("px", ""));	
//		var ML=Math.abs(MarginLeft);
//			if(ML<SW&&ML>=SW/2){
//					$('#mainPart').animate({marginLeft: -SW+ "px"},100);
...
//			}else if(ML<SW/2){
//					$('#mainPart').animate({marginLeft: "0px"},100);
//			}else if(ML>=SW&&ML<1.5*SW){
//					$('#mainPart').animate({marginLeft: -SW+"px"},100);
//			}else if(ML>=1.5*SW&&ML<2*SW){
//					$('#mainPart').animate({marginLeft: -2*SW+ "px"},100);
//					$(".footerBask span").css("color","rgb(225,51,61)");
//					$(".footerBask img").attr("src",cameraRedUrl);
//					$(".footerNewest span").css("color","rgb(157,157,170)");
//					$(".footerNewest img").attr("src",starGrayUrl);
//			}else if(ML>=2*SW&&ML<2.5*SW){
//					$('#mainPart').animate({marginLeft: -2*SW+ "px"},100);
//			}else if(ML>=2.5*SW&&ML<3*SW){
//					$('#mainPart').animate({marginLeft: -3*SW+ "px"},100);
//					$(".footerTobuy span").css("color","rgb(225,51,61)");
//					$(".footerTobuy img").attr("src",cartRedUrl);
//					$(".footerBask span").css("color","rgb(157,157,170)");
//					$(".footerBask img").attr("src",cameraGrayUrl);
//			}else if(ML>=3*SW&&ML<3.5*SW){
//					$('#mainPart').animate({marginLeft: -3*SW+ "px"},100);
//			}else if(ML>=3.5*SW&&ML<4*SW){
//					$('#mainPart').animate({marginLeft: -4*SW+ "px"},100);
//					$(".footerMy span").css("color","rgb(225,51,61)");
//					$(".footerMy img").attr("src",userRedUrl);
//					$(".footerTobuy span").css("color","rgb(157,157,170)");
//					$(".footerTobuy img").attr("src",cartGrayUrl);
//			}
